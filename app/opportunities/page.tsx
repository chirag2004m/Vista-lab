    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '72px 40px 80px' }}>
      <div style={{ marginBottom: 52 }}>
        ...
        <p style={{ fontSize: 15, color: 'var(--text-secondary)', lineHeight: 1.6, maxWidth: 560 }}>
          We're always looking for talented, motivated individuals to join our lab. Here are our current openings.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 20 }} className="opp-grid">
        {opportunities.map(opp => {
          ...
          return (
            <div key={opp.id}
              style={{ background: '#0d1117', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: '28px 28px 24px', display: 'flex', flexDirection: 'column', transition: 'border-color 0.2s, transform 0.2s, box-shadow 0.2s' }}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                ...
                {daysLeft <= 0 && <span style={{ fontSize: 10, padding: '3px 10px', borderRadius: 100, fontFamily: 'Space Mono, monospace', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.25)' }}>Closed</span>}
              </div>
      ...
      <div style={{ marginTop: 56, padding: '36px 40px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', lineHeight: 1.6, maxWidth: 480, margin: '0 auto 20px' }}>
          We welcome motivated researchers who align with our mission. Send your CV and a brief research statement.
        </p>
